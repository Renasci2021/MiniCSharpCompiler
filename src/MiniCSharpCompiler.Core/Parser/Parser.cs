...
public class Parser(List<SyntaxToken> tokens)
{
    ...
    private NameSyntax ParseQualifiedName()
    {
        ...
        {
            MatchToken(SyntaxKind.DotToken); // ����Դ�޸�
...
#pragma warning restore CS8625 // 无法将 null 字面量转换为非 null 的引用类型。
    ...
    /// ȱһ��OmittedArraySizeExpression��֧�֣�int x[];��
    /// </summary>
    /// <returns></returns>
    /// <exception cref="NotImplementedException"></exception>
    ...
    /// ����embedded�����Ϊ��ֹ��if (j != 0) int k;��
    /// ͬʱ������if (_elements.Count == 0) throw new InvalidOperationException("Stack is empty.");��
    /// �ķ��ӽ�LL(1)��
    /// </summary>
    /// <returns></returns>
    ...
    /// <summary>
    /// Roslynû��STATEMENT_EXPRESSION�������ͣ���Ҫ�Լ����
    /// </summary>
    /// <returns></returns>
    /// <exception cref="NotImplementedException"></exception>
